...
from LV import LargeVocabulary
...
if __name__ == "__main__":
    ...
    # Construct model
    encoder = BidirectionalEncoder(10000, 100, 1000)
    decoder = Decoder(10000, 100, 1000, 2000)
    ...
    main_loop = MainLoop(
        ...
        extensions=[
            LargeVocabulary(enc_embds=enc_param_dict['/bidirectionalencoder/embeddings.W'],
                            dec_embds=dec_param_dict['/decoder/sequencegenerator/readout/lookupfeedbackwmt15/lookuptable.W'],
                            out_embds=dec_param_dict['/decoder/sequencegenerator/readout/initializablefeedforwardsequence/linear.W'],
                            bias_embds=dec_param_dict['/decoder/sequencegenerator/readout/initializablefeedforwardsequence/linear.b'],
                            enc_LV_len=100000, dec_LV_len=100000,
                            Dx_name='/data/lisatmp3/jeasebas/nmt/debug_blocks_LV/en2fi_100k_2k_Dx_file',
                            Dy_name='/data/lisatmp3/jeasebas/nmt/debug_blocks_LV/en2fi_100k_2k_Dy_file',
                            rolling_vocab_fname='/data/lisatmp3/jeasebas/nmt/debug_blocks_LV/en2fi_100k_2k_rolling_vocab_dict.pkl',
                            rng=numpy.random.RandomState(1), mean=0., std=0.01,
                            src_name='finnish', trg_name='english'),
